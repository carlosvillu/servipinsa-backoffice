    ...
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      <nav className="fixed top-0 left-0 bottom-0 w-64 bg-[#F4EFEA] border-r border-[#383838] flex flex-col">
        ...
        <div className="h-[70px] px-6 flex items-center justify-between border-b border-[#383838]">
          ...
          <button
            onClick={onClose}
            className="font-mono text-[#383838] text-2xl leading-none p-1"
        ...
        <div className="flex-1 flex flex-col px-6 py-6 gap-2">
          <Link
            to="/"
            onClick={onClose}
            className="font-mono uppercase tracking-wider text-sm text-[#383838] py-3 border-b border-[#E0E0E0] hover:text-[#2BA5FF] transition-colors"
          >
            Partes
          </Link>
          {user.role === 'MANAGER' && (
